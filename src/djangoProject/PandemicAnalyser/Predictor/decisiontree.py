...
#11
train2 = [("Happy Lockdown 6.0! - Drinking a Triple Tripel Straight Up by @thehowlinghound @ Bringabeeralong Holiday House", "pos"),
        ...
        ("I love sweets", "pos"),
        ("My family give me such great support", "pos"),
        ("Games are so enjoyable", "pos"),
        ("So special to me! I cherish these memories so much", "pos"),
        ("I'm so happy to spend my time in sunny weather", "pos"),
        ...
        ("I hate cheesecake", 'neg'),
        ("I am so exhausted, I hate work", 'neg'),
        ("The UFC is disgusting and  barbaric", 'neg'),
        ("Our government is corrupt and evil", 'neg'),
        ("Most people are fake, ignorant and ill-intentioned", 'neg')
         ]
